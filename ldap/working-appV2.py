...
def run_command_thread(ip, action, username, password):
    return run_command(ip, action, username, password)

def run_patch_update_thread(ip, apply_patches, username, password):
    return run_patch_update(ip, apply_patches, username, password)
def apply_patches_and_reboot_thread(ip, username, password):
    return apply_patches_and_reboot(ip, username, password)
